        ...
        <Modal bind:show={modalVisible}
            ...
            <div class={"px-3 pt-3 sm:px-6 sm:py-2.5"}>
                ...
                <div class={"flex items-center gap-5 mb-5"}>
                    <div class={"w-1/2"}>
                        ...
                        <input type="text" value={"Marie"} disabled={true}
                               class={"px-3 py-1.5 border rounded-lg border-gray-300 bg-white w-full"}/>
                    </div>
                    <div class={"w-1/2"}>
                ...
                <div class={"mb-5"}>
                    ...
                    <input type="email" value={"juchelkova@scg.cz"} disabled={true}
                           class={"px-3 py-1.5 border rounded-lg border-gray-300 bg-white w-full"}/>
                </div>
                <div class={"flex items-center gap-5 mb-5"}>
                    <div class={"w-1/2"}>
                        <p class={"mb-1"}>Telefon:</p>
                        <input type="tel" value={"+420 733 333 233"} disabled={true}
                               class={"px-3 py-1.5 border rounded-lg border-gray-300 bg-white w-full "}/>
                    </div>
                    <div class={"w-1/2"}>
                        <p class={"mb-1"}>Vybraný Tag:</p>
                        <select id={"time"} class={"px-3 py-1.5 border rounded-lg border-gray-300 bg-white w-full "}
                                disabled={true}>
                ...
                <div class={"flex items-center gap-5 mb-5"}>
                    <div class={"w-1/2"}>
                        ...
                        <input type="date" value={"Jana"} disabled={false}
                ...
                <div class={"mb-5"}>
                    ...
                    <textarea name="note" id="note" cols={50} rows={6}
                              class={"px-3 py-1.5 border rounded-lg border-gray-300 bg-white w-full resize-none text-sm"}
