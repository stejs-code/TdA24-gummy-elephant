            ...
            <div class={"w-full max-w-5xl m-auto px-4"}>
                <div class={"flex w-full justify-between items-center"}>
                    ...
                    <div class={"flex"}>
                        <Link href={"#"}>
                            <div
                                class={"bg-primary-200 text-primary-400 mr-2 rounded-xl px-2 py-2 cursor-pointer hover:scale-125 duration-150"}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                     stroke-linejoin="round" class="lucide lucide-table-properties ">
                                    <path d="M15 3v18"/>
                ...
                <div class={"flex gap-6 justify-start lg:justify-center overflow-x-scroll overflow-y-hidden py-10"}>
                    {
                        workDays.map((day, index) => (
                            ...
                            <Table key={index} closeModal={modalVisible} day={day}
                                   isCurrentDay={(new Date()).getDay() == index + 1}/>
                        ))
                    }
                </div>
