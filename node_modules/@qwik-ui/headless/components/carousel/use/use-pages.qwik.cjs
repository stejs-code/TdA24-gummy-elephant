...
const usePages = (ref, params) => {
  ...
  const ranges = qwik.useSignal([]);
  const total = qwik.useComputedQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
    const [ranges2] = qwik.useLexicalScope();
    return ranges2.value.length;
  }, "usePages_total_useComputed_Tk6xK4k2yQo", [
    ranges
  ]));
  const current = qwik.useComputedQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
    const [params2, ranges2] = qwik.useLexicalScope();
  ...
  const computePages = /* @__PURE__ */ qwik.inlinedQrl(() => {
    const [ranges2, ref2] = qwik.useLexicalScope();
    let acc = 0;
  ...
  const scrollAt = /* @__PURE__ */ qwik.inlinedQrl((index) => {
  ...
  const previous = /* @__PURE__ */ qwik.inlinedQrl(() => {
    const [current2, loop2, params2, ranges2, scrollAt2] = qwik.useLexicalScope();
  ...
  const next = /* @__PURE__ */ qwik.inlinedQrl(() => {
    const [current2, loop2, ranges2, scrollAt2, total2] = qwik.useLexicalScope();
  ...
  qwik.useVisibleTaskQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
    const [computePages2] = qwik.useLexicalScope();
    return computePages2();
  }, "usePages_useVisibleTask_1yNtW2XyCAI", [
    computePages
  ]));
  qwik.useOnWindow("resize", computePages);
  return {
    total,
    ranges,
    current,
...
exports.getPageFromActiveItem = getPageFromActiveItem;
