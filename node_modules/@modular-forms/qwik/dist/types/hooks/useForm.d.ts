 ...
 */
export declare function useForm<TFieldValues extends FieldValues, TResponseData extends ResponseData = undefined>(options: FormOptions<TFieldValues, TResponseData>): [
    FormStore<TFieldValues, TResponseData>,
    {
        Form: (props: Omit<FormProps<TFieldValues, TResponseData>, 'of' | 'action'>) => JSX.Element;
