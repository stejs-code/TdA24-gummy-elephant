 ...
 */
type TypeTemplatePath<Key extends string | number, Value, Type> = Value extends Type ? Value extends Array<any> | Record<string, any> ? `${Key}` | `${Key}.${TypeTemplatePaths<Value, Type>}` : `${Key}` : Value extends FieldValues | (FieldValue | FieldValues)[] ? `${Key extends number ? '$' : Key}.${TypeTemplatePaths<Value, Type>}` : never;
/**
